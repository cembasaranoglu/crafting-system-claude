# 93 — Prompt Upgrade From Run Failures

Mode: PROMPT_RETROSPECTIVE
...
Analyze failed Claude/Cursor/Codex runs and propose prompt patches plus regression tests that would prevent recurrence without overfitting.
...
`run_failure_analysis.md`, `root_cause_map.yaml`, `prompt_patch_recommendations.md`, `regression_test_cases.md`, `updated_prompt_snippets.md`, `run_summary.md`
