...
Detect claims in docs, reports, release notes, architecture, and assistant output that are not supported by source evidence.
...
`unsupported_claims.md`, `claim_severity_register.yaml`, `safe_rewording_suggestions.md`, `evidence_needed.md`, `run_summary.md`
