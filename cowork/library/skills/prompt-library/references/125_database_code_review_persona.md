# 125 — Database Code Review Persona
...
Review transactions, migrations, locking, isolation, indexes, query bounds, connection lifecycle, rollback, and data integrity.
