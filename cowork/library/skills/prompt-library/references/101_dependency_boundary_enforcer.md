# 101 — Dependency Boundary Enforcer

Mode: BOUNDARY_ENFORCEMENT
...
Review repository dependencies for invalid imports, forbidden layer access, cycles, framework leakage, and public/internal boundary violations.
...
`dependency_boundary_report.md`, `forbidden_dependency_matrix.yaml`, `violations.md`, `remediation_plan.md`, `run_summary.md`
