# 108 — Repository Intelligence Database Builder
...
Build a durable repo intelligence database: features, runtime surfaces, API/config/storage/docs/test surfaces, validation commands, glossary, and unknowns.
...
`.repository-intel/feature_inventory.yaml`, `.repository-intel/runtime_surfaces.yaml`, `.repository-intel/api_surface.yaml`, `.repository-intel/config_surface.yaml`, `.repository-intel/storage_surface.yaml`, `.repository-intel/docs_surface.yaml`, `.repository-intel/test_surface.yaml`, `.repository-intel/validation_commands.yaml`, `.repository-intel/glossary.yaml`, `.repository-intel/unknowns.yaml`, `run_summary.md`
