# 94 — Evidence Ledger and Traceability

Mode: EVIDENCE_LEDGER
...
Map every important claim to source files, code paths, docs, tests, commands, or explicit assumptions with confidence.
...
`evidence_ledger.yaml`, `claim_confidence_register.yaml`, `unsupported_claims.md`, `source_to_claim_map.yaml`, `run_summary.md`
