...
description: Audit OSS governance, license, community, release, and OpenSSF posture.
---
# oss-release-readiness

Use this skill when the user requests: Audit OSS governance, license, community, release, and OpenSSF posture.

## Source prompt references

Primary prompt-system reference: `prompts/72_oss_governance_license_community_readiness.md`.
