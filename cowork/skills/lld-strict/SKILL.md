---
name: lld-strict
description: Create a strict low-level design with module contracts, behavior matrix, path plan, and coding handoff.
---
# lld-strict

Use this skill when the user requests: Create a strict low-level design with module contracts, behavior matrix, path plan, and coding handoff.

## Source prompt references

Primary prompt-system reference: `prompts/29_low_level_design_strict.md`.
