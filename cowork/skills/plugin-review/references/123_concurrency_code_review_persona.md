# 123 — Concurrency Code Review Persona
...
Review race risk, goroutine/thread leaks, cancellation, shutdown, locks, channels, worker pools, retries, and bounded resources.
