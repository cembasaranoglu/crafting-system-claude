...
description: Analyze a repository and produce an evidence-backed feature inventory with implemented/partial/docs-only/not-implemented status.
---
# feature-inventory

Use this skill when the user requests: Analyze a repository and produce an evidence-backed feature inventory with implemented/partial/docs-only/not-implemented status.

## Source prompt references

Primary prompt-system reference: `prompts/03_feature_inventory_and_readiness_audit.md`.
