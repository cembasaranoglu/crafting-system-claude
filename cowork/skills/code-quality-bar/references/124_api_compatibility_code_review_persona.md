# 124 — API Compatibility Code Review Persona
...
Review API/CLI/config/event/schema compatibility, versioning, deprecation, idempotency, and backward compatibility.
