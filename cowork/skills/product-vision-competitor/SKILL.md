---
name: product-vision-competitor
description: Analyze product vision, positioning, problem/solution fit, and competitor comparison from source evidence and allowed research.
---
# product-vision-competitor

Use this skill when the user requests: Analyze product vision, positioning, problem/solution fit, and competitor comparison from source evidence and allowed research.

## Source prompt references

Primary prompt-system reference: `prompts/80_product_vision_market_readiness.md and prompts/12_competitor_analysis.md`.
