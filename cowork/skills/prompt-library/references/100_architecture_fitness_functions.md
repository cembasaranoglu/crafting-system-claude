# 100 — Architecture Fitness Functions

Mode: ARCHITECTURE_FITNESS
...
Create checks that detect drift from intended boundaries, layering, runtime surfaces, public/internal contracts, and dependency rules.
...
`architecture_fitness_functions.md`, `boundary_rules.yaml`, `fitness_validation_plan.md`, `architecture_drift_report.md`, `run_summary.md`
