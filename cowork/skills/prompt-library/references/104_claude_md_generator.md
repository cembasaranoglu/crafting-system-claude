...
Generate repository-specific CLAUDE.md with safe commands, conventions, forbidden paths, validation matrix, and stage boundaries.
...
`CLAUDE.md.draft`, `claude_context_source_map.yaml`, `claude_command_catalog.md`, `claude_forbidden_actions.md`, `run_summary.md`
