# 110 — Source-Cited Repository Answerer

Mode: SOURCE_CITED_QA
...
Answer repository questions only from known source evidence; state confidence, unknowns, and exact areas searched.
...
`answer.md`, `evidence_used.yaml`, `unknowns_and_assumptions.md`, `follow_up_search_queries.md`, `run_summary.md`
