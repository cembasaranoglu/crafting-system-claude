# 109 — Repository Q&A Knowledge Base Builder
...
Create a source-backed technical and non-technical Q&A knowledge base so future questions can be answered quickly and safely.
...
`repo_qa_knowledge_base.md`, `technical_question_index.yaml`, `nontechnical_question_index.yaml`, `answer_source_map.yaml`, `question_routing_map.md`, `run_summary.md`
