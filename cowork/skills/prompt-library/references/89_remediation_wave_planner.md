# 89 — Remediation Wave Planner

Mode: REMEDIATION_WAVES
...
Turn readiness/code/architecture gaps into small, ordered, codeable remediation waves with non-scope, touched-path candidates, validation, and next prompt.
...
`remediation_wave_plan.md`, `remediation_wave_manifest.yaml`, `gap_to_wave_map.md`, `wave_dependency_graph.md`, `first_wave_code_authoring_prompt.md`, `run_summary.md`
