# 121 — Security Code Review Persona
...
Review code for auth, input validation, secrets, injection, SSRF, path traversal, logging leaks, dependency risk, and secure defaults.
