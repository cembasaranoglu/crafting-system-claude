# 120 — Legacy to Clean Architecture Migration
...
Plan incremental migration toward cleaner domain/application/infrastructure boundaries while preserving behavior.
