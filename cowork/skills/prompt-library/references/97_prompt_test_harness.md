...
Design prompt tests using fixture repos, sample source packets, expected artifacts, negative cases, and regression checks.
...
`prompt_test_strategy.md`, `fixture_inventory.yaml`, `golden_output_plan.md`, `prompt_lint_rules.md`, `test_runner_design.md`, `run_summary.md`
