# 130 — Protected Branch, Signed Commit, and Push Gate

Mode: SPECIALIZED_GATE
...
Prepare safe git add/commit/push instructions with protected branch checks, signed commit/tag policy, and no-force-push guardrails.
