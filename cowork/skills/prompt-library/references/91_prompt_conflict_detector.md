# 91 — Prompt Conflict Detector

Mode: PROMPT_CONFLICTS
...
Find contradictions between base prompts, stage prompts, plugin skills, agents, Cursor rules, AGENTS.md, CLAUDE.md, and user instructions.
...
`prompt_conflict_register.yaml`, `authority_precedence_map.md`, `conflict_resolution_plan.md`, `safe_patch_recommendations.md`, `run_summary.md`
