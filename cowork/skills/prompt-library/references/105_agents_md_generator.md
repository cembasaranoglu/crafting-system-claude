...
Generate AGENTS.md instructions for AI coding agents with validation commands, coding standards, path ownership, and nested override strategy.
...
`AGENTS.md.draft`, `nested_agent_strategy.md`, `agent_instruction_source_map.yaml`, `run_summary.md`
