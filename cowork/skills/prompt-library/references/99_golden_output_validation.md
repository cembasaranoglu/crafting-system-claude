# 99 — Golden Output Validation

Mode: GOLDEN_VALIDATION
...
Define stable golden outputs and compare prompt output against expected schemas, required sections, and forbidden claims.
...
`golden_output_contract.md`, `schema_validation_matrix.yaml`, `diff_interpretation_policy.md`, `golden_update_policy.md`, `run_summary.md`
