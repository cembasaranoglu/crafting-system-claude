...
Generate AI-ready context files for Claude, Cursor, AGENTS.md, and llms.txt from repository evidence without leaking private workspace assumptions.
...
`ai_context_compilation_plan.md`, `CLAUDE.md.draft`, `AGENTS.md.draft`, `.cursor/rules.draft/`, `llms.txt.draft`, `docs/ai/context-map.md.draft`, `run_summary.md`
