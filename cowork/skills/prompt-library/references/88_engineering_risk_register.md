...
Create a durable engineering risk register with severity, likelihood, impact, owner, evidence, mitigation, acceptance criteria, and validation path.
...
`engineering_risk_register.yaml`, `risk_heatmap.md`, `blocker_register.md`, `risk_acceptance_register.md`, `mitigation_validation_plan.md`, `run_summary.md`
