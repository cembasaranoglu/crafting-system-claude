---
name: plugin-review
description: Reviews Claude Code plugins for manifest structure, skill design, agents,
  hooks, MCP, LSP, monitors, permissions, security, documentation, and packaging readiness.
  Use when reviewing a plugin or plugin plan.
