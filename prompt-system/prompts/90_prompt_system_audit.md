...
Audit the prompt pack for missing gates, weak instructions, unsafe tool use, conflicting prompts, and fabricated-validation risk.
...
`prompt_system_audit.md`, `prompt_conflict_register.yaml`, `coverage_gap_report.md`, `prompt_quality_scorecard.md`, `recommended_patch_plan.md`, `run_summary.md`
