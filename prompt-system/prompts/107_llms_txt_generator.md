...
Generate public-safe llms.txt and optional llms-full.txt for documentation discovery by LLMs.
...
`llms.txt.draft`, `llms-full.txt.draft`, `docs_index_map.yaml`, `public_private_content_review.md`, `run_summary.md`
