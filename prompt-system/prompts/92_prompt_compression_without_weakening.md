# 92 — Prompt Compression Without Weakening

Mode: PROMPT_COMPRESSION
...
Reduce prompt length while preserving non-negotiable rules, stage boundaries, schemas, validation honesty, and safety gates.
...
`compression_plan.md`, `must_keep_rules.yaml`, `removed_redundancy_report.md`, `compressed_prompt_drafts.md`, `weakening_risk_report.md`, `run_summary.md`
