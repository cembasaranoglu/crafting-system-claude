# 102 — Runtime Surface Drift Detector
...
Detect drift between documented runtime surfaces and actual code, config, deployment, API, CLI, worker, or scheduler surfaces.
...
`runtime_surface_drift_report.md`, `documented_vs_actual_surface_matrix.yaml`, `missing_or_orphan_surfaces.md`, `contract_alignment_plan.md`, `run_summary.md`
