...
Generate Cursor project rules from repository facts, conventions, validation commands, forbidden paths, and safe Git behavior.
...
`.cursor/rules/00-project-core.mdc.draft`, `.cursor/rules/10-code-quality.mdc.draft`, `.cursor/rules/20-testing-validation.mdc.draft`, `.cursor/rules/30-security-git.mdc.draft`, `run_summary.md`
